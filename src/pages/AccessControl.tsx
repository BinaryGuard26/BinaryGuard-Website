...
export default function AccessControl({ onNavigate }: AccessControlProps) {
  return (
    <main className="min-h-screen bg-[#020817] text-white pt-24">
      ...
      <section className="bg-[#020817] border-t border-white/10 px-6 py-10">
        <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-6 text-white">
          <div>
            <h3 className="text-cyan-400 text-xl font-bold mb-2">BinaryGuard</h3>
            <p className="text-slate-400 text-sm">Secure access control and card ordering support.</p>
          </div>
          <div>
            <h4 className="font-bold mb-2">Contact</h4>
            <p className="text-slate-400 text-sm">+1 204-504-5000</p>
            <p className="text-slate-400 text-sm">admin@binaryguard.ca</p>
          </div>
          <div>
            <h4 className="font-bold mb-2">Business Hours</h4>
            <p className="text-slate-400 text-sm">Mon–Fri: 10:00 AM – 7:00 PM</p>
            <p className="text-slate-400 text-sm">Sat: 11:00 AM – 6:00 PM</p>
          </div>
          <div>
            <h4 className="font-bold mb-2">Need Help?</h4>
            <button
              onClick={() => onNavigate?.("contact")}
              className="bg-cyan-500 hover:bg-cyan-400 text-slate-950 font-semibold px-5 py-2 rounded-xl"
            >
              Contact Support
            </button>
          </div>
